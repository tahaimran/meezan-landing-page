            ...
            <div className="col-md-4">
             ...
             <AccessTime className='icon' sx={{fontSize: 50 }}/>
               ...
               <AssuredWorkload className='icon' sx={{ fontSize: 50 }}/>    
                ...
                <p>You from our involvement with conveying successful answers for the complex worldwide stockpile chains of a portion of the world's greatest partnerships.</p>
            </div>
            </div>
        </div>
    )
